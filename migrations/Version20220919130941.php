 ...
 */
final class Version20220919130941 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, reference_id INT NOT NULL, color_id INT NOT NULL, size_id INT NOT NULL, qty INT NOT NULL, INDEX IDX_23A0E661645DEA9 (reference_id), INDEX IDX_23A0E667ADA1FB5 (color_id), INDEX IDX_23A0E66498DA827 (size_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
